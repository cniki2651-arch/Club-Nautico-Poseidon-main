...
1. **Secretaría:** Gestión de solicitudes e inscripciones.
2. **Jefatura:** Aprobaciones, retiros y métricas.
3. **Naviero:** Control de flota, asignación de radas y permisos de zarpe.
4. **Finanzas:** Facturación, fraccionamientos y cálculo de morosidad (Tasa SBS).
